...
# Parsing + Configuration Script – MachIO - Rev. B

This **Parsing + Configuration** script is designed for the **MachIO** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – MachIO Rev. B

Este script de **Parsing + Configuration** está diseñado para el modelo **MachIO** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
